...
function Patient() {
  ...
  const handleAddPatient = (newPatient) => {
    ...
    axios.post(' 13.236.137.171:5000/patients', newPatient)
      .then((response) => {
  ...
  useEffect(() => {
    axios.get("13.236.137.171:5000/patients")
  .then((response) => {
  ...
  const handleDeletePatient = (PatientId) => {
    ...
    axios.delete(`13.236.137.171:5000/patients/${PatientId}`)
      .then(() => {
  ...
  const handleEditPatient = (editedPatient) => {
    ...
    axios.put(` 13.236.137.171:5000/patients/${editedPatient.id}`, editedPatient)
      .then(() => {
