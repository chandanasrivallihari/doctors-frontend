...
function Doctorr() {
  ...
  const handleAddDoctor = (newDoctor) => {
    ...
    axios.post(" 13.236.137.171:5000/doctors", newDoctor)
      .then((response) => {
  ...
  useEffect(() => {
    axios.get(" 13.236.137.171:5000/doctors")
      .then((response) => {
  ...
  const handleDeleteDoctor = (doctorId) => {
    ...
    axios.delete(`13.236.137.171:5000/doctors/${doctorId}`)
      .then(() => {
  ...
  const handleEditDoctor = (editedDoctor) => {
    ...
    axios.put(`13.236.137.171:5000//doctors/${editedDoctor.id}`, editedDoctor)
      .then(() => {
